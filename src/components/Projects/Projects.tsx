        ...
        >
          {projectsData.map((project, index) => (
            <SwiperSlide key={index} className="h-auto">
              <div className="group border border-gray-200 dark:border-white/20 rounded-xl p-6 flex flex-col min-h-66 transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-[0_0_15px_5px_rgba(249,192,21,0.2)] dark:hover:border-[#F9C015]/40">
