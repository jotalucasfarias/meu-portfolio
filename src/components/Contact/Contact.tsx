    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="w-16 h-1 bg-yellow-500 mt-3 mb-8 mx-auto"></div>
        ...
        {/* Ícones Sociais */}
        <div
          className={`flex justify-center gap-6 mt-8 transition-all duration-700 ease-out delay-100 ${
            inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}
        >
          <a
        ...
        {/* Formulário */}
        <form
          className={`mt-12 max-w-3xl mx-auto transition-all duration-700 ease-out delay-200 ${
            inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}
        >
